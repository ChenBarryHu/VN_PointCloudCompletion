...
class PCNNet(nn.Module):
    def __init__(self, config, enc_type="dgcnn_fps", dec_type="foldingnet", enc_pretrained="/home/barry/guided_research/PCN-PyTorch/experiments/07-09_448_points_dgcnn_fps_000/models/model_best.pth", dec_pretrained=None):
        super().__init__()
